...
public class SimpleTest {
	...
	void testSimpleSicstusFastRw() throws Exception {
		...
		pathMachine.toFile().deleteOnExit();
		pathData.toFile().deleteOnExit();
	}
